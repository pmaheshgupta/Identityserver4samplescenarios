...
namespace IdentityServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var user = new ApplicationUser();//_users.FindByExternalProvider(provider, userId);
            //if (user == null)
            //{
            ...
            //}
        //    throw new  Exception("need to implement auto provision user for external provider above");
            ...
            await HttpContext.Authentication.SignInAsync(user.Id, user.UserName="mahesh", provider, props, additionalClaims.ToArray());
